...
function setup()    
    ...
    thePath = basedir -- myDirect:getAbsolutePath()            -- get current path
    --print ("path", myDirect:getPath())
    theImgDirectory =  thePath .. "/Image/Images"         -- look in 'Images'
